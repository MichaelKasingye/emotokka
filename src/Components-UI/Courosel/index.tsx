...
export default function CouroselComponent({}: CouroselComponentProps) {
  return (
    <Carousel className="border border-4 overflow-hidden" style={{maxHeight:"600px"}}>
      <Carousel.Item>
        <div  >
        <img
      ...
      <div>
        <img
          className="d-block w-100"
          src="https://images.pexels.com/photos/112452/pexels-photo-112452.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt="Second slide"
        />
        </div>
